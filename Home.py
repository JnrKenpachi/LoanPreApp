...
def main():
    ...
    def get_base64_image(image_path):
     ...
     #Convert your local image (ensure the path is correct)
    ...
    team_members = [
        {"name": "Bernardine Akorfa Gawu", "id": "22253324", "role": "Data Scientist","image": "Images/Akorfa.png"},
        {"name": "Abigail Amissah", "id": "22253929", "role": "ML Engineer", "image": "Images/Abigail.jpg"},
        {"name": "Samuel Asare", "id": "22253156", "role": "Full Stack Developer", "image": "Images/Sam.png"},
        {"name": "Afful Francis Gyan", "id": "22253332", "role": "Data Analyst", "image": "Images/Francis.png"},
        {"name": "Gloria Odamtten", "id": "22252377", "role": "Project Manager", "image": "Images/Gloria.png"}
    ]
